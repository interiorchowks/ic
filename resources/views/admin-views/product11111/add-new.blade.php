                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text" placeholder="{{ \App\CPU\translate('HSN Code') }}"
                                            value="{{ old('HSN_code') }}" name="HSN_code" class="form-control" required>
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label class="title-color">{{ \App\CPU\translate('Return_Days') }}</label>
                                        <input type="number" min="0" step="0.01"
                                            placeholder="{{ \App\CPU\translate('Return days') }}"
                                            value="{{ old('Return_days') }}" name="Return_days" class="form-control"
                                            required>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-end">
                                        <div class="col-md-6 form-group">
                                            <label class="title-color">{{ \App\CPU\translate('MRP') }} (Actual Selling
                                                Price <span id="selling_price_">0.00</span>)</label>
                                        ...
                                        <div class="col-md-2 form-group">
                                            ...
                                            <select name="tax_model" class="form-control" disabled>
                                                <option value="include" selected>{{ \App\CPU\translate('include') }}
                                                </option>
                                        ...
                                        <div class="col-md-2 form-group">
                                            ...
                                            <select class="form-control" id="discount_type_" name="discount_type">
                                        ...
                                        <div class="col-md-3 form-group physical_product_show" id="shipping_cost">
                                            ...
                                            <input type="number" min="0" value="0" step="1"
                                                ...
                                                name="shipping_cost" class="form-control" disabled>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3 physical_product_show" id="shipping_cost_multy1">
                                            <div
                                                class="border rounded px-3 py-2 min-h-40 d-flex justify-content-between gap-3">
                                                <label class="title-color mb-0">{{ \App\CPU\translate('free_delivery') }}
                                                </label>

                                                <label class="switcher">
                                                    <input class="switcher_input" type="checkbox" name="free_delivery"
                                                        id="">
                                                    <span class="switcher_control"></span>
                                                </label>
                                            </div>
