                                        ...
                                        <div class="form-group position-relative">
                                            <div class="form-check text-right">
                                                <input type="radio" id="featured-{{ $key + 1 }}"
                                                    ...
                                                    data-address-id="{{ $addres->id }}" {{ $addres->is_selected == 1 ?
                                                'checked' : '' }}>
                            ...
                            <li class="offerListContent">
                                                    ...
                                                    <div class="offCoupLeftWrap">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p style="font-size: 11px">Valid till :
                                                                {{
                                                                \Carbon\Carbon::parse($coupon->expire_date)->format('d
                                                                M, Y') }}
                                                            </p>
                                                        </div>
                                                    </div>
                                ...
                                <div
                                    ...
                                    <div>
                                        ...
                                        <p>Available Balance: <span id="wallet_balance">₹{{ $balance ? $balance : 0
                                                }}</span></p>
                                    </div>
                                    @if ($balance == 0)
                                    <div>
                        ...
                        <div class="billBreakdownWrapper">
                            ...
                            <div class="amtBrkdownWrapper">
                                ...
                                <div class="cillBrkCnt">
                                    ...
                                    <span id="total-amount" class="d-flex">₹{{ $total_variant_mrp - ($total_variant_mrp
                                        - $total_listed_price) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-12">
                    <div class="mobileAddrWrapper">
                        ...
                        <div class="addrMainWrap">
                            ...
                            <div class="custom_radio">
                                <div class="form-group position-relative border-bottom-0 selected">
                                    <div class="form-check pl-0">
                                        <input type="radio" name="shipAddMob" id="shipAdd3" checked required>
                                        <label for="shipAdd3" class="mb-0">Same as Shipping address</label>
                                    </div>
                                </div>

                                <div class="form-group position-relative">
                                    <div class="form-check pl-0">
                                        <input type="radio" name="shipAddMob" id="shipAdd4">
                                        <label for="shipAdd4" class="mb-0">Use a different billing address</label>
                                    </div>

                                    <!-- Dropdown Wrapper -->
                                    <div class="selAddWrappers mob-inp mt-1 mb-1" style="display:none;">
                                        <select class="form-control">
                                            <option value="1">Rishi Mathur - Moradabad</option>
                                            <option value="2">Aman Bhatnagar - Ghaziabad</option>
                                            <option value="3">Suramya Singh - Noida</option>
                                        </select>
                        ...
                        <div class="addrMainWrap">
                            ...
                            <div class="mob-inp" style="display: none;">
                        ...
                        <div class="addrMainWrap">
                            <div class="billBreakdownWrapper">
                                ...
                                <div class="amtBrkdownWrapper">
                                    ...
                                    <div class="cillBrkCnt">
                                        <label>Bag Saving</label>
                                        <span class="d-flex">-₹4571</span>
                                    </div>
                                    <hr>
                                    <div class="cillBrkCnt">
                                        <label class="d-flex align-items-center justify-content-start">Coupon &
                                            Voucher<img src="{{ asset('storage/app/public/images/discount_87.png') }}"
                                                class="img-fluid" alt="voucher" /></label>
